...
export const LoginAgentKeyPage = lazy(() =>
  import("./login-agent-key").then((m) => ({ default: m.LoginAgentKeyPage })),
);
export const LoginCodePage = lazy(() =>
  import("./login-code").then((m) => ({ default: m.LoginCodePage })),
);
