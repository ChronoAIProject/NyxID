  ...
  "inline-flex items-center rounded-[10px] border px-2.5 py-1 text-[10px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-success/25 bg-transparent text-success",
        warning:
          "border-warning/25 bg-transparent text-warning",
        info:
          "border-info/25 bg-transparent text-info",
        accent:
          "border-primary/25 bg-transparent text-void-400",
      },
    },
    defaultVariants: {
      variant: "default",
