...
export function SocialLoginButtons() {
  ...
  function handleSocialLogin(provider: ProviderId) {
    ...
    const platformParam = isNative ? "?platform=native" : "";
    const returnUrl = `${base}/api/v1/auth/social/${encodedProvider}${platformParam}`;
  ...
  return (
    <div className={`grid gap-3 ${enabledProviders.length === 1 ? "grid-cols-1" : enabledProviders.length === 2 ? "grid-cols-2" : "grid-cols-3"}`}>
