...
const WAVE_3_4_JOURNEYS: readonly JourneyOptions[] = [
  ...
  },
  {
    ...
    dialogParams: { orgId: "org-member", userId: "user-add", role: "member" },
  ...
  },
  {
    ...
    cta: "Create invite",
    dialogAction: "invite",
    dialogParams: { orgId: "org-invite", role: "viewer" },
  ...
  },
  {
    ...
    rawParams: { name: "Deploy agent", description: "Production deploys" },
    ...
    dialogAction: "create",
    dialogParams: { name: "Deploy agent", description: "Production deploys" },
  ...
  },
  {
    ...
    rawParams: { label: "GCP production" },
    ...
    dialogParams: { label: "GCP production" },
