...
impl ServiceCredential {
    ...
    pub fn raw_credential(&self) -> Option<&str> {
        match &self.injection {
            ...
            // SigV4 credentials are structured JSON blobs, not raw token
            // strings — surfacing them via WS frame templates would leak
