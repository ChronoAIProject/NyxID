...
- 12300 `WorkspaceDestinationsNotActivated` (HTTP 503): temporary Workspace editor activation gate; expected rollout state, excluded from proxy-fault telemetry
