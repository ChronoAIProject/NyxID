...
- `ApiKey.allow_auto_connected_services` adds active, same-owner auto-provisioned service IDs to restricted keys at auth-context construction; defaults to false.
