...
simpler service-account catalog grants, typed X channel activity, and CI
improvements for review before they land in `main`.
...
| [#1667](https://github.com/ChronoAIProject/NyxID/pull/1667) | Final head recorded on the source PR | `52993e8f5ea0631aa8aeaa479fdbbe849cc48732` | Grant platform-wide catalog access through administrator-saved SA scopes; remove the separate activation form; preserve token and live authority checks, private connection isolation, and Ornn proxy permissions. |
