...
> **Windows users:** Run this curl from a Unix-compatible shell — WSL Ubuntu (recommended) or Git Bash both work. See [Windows setup](../../README.md#windows-setup) in the main README.
