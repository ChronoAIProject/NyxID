...
> **Windows users:** Run every command on this page from a WSL Ubuntu shell — see [Windows setup](../../README.md#windows-setup) in the main README. Native PowerShell and CMD are not supported.
