...
pub struct PublicConfigResponse {
    ...
    pub oauth_return_routes_enabled: bool,
...
pub async fn public_config(State(state): State<AppState>) -> Json<PublicConfigResponse> {
    ...
    Json(PublicConfigResponse {
        ...
        oauth_return_routes_enabled: state.config.oauth_return_routes.is_some(),
        telemetry_dsn,
        telemetry_host,
...
mod tests {
    ...
    fn public_config_response_serializes_required_fields() {
        let resp = PublicConfigResponse {
            ...
            oauth_return_routes_enabled: false,
            telemetry_dsn: None,
            telemetry_host: None,
    ...
    fn public_config_response_includes_telemetry_when_set() {
        let resp = PublicConfigResponse {
            ...
            invite_code_required: false,
            email_auth_enabled: false,
            oauth_return_routes_enabled: true,
        ...
        assert_eq!(json["oauth_return_routes_enabled"], true);
    }
}
